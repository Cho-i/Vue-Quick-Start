...
[ex07-13.js](https://cho-i.github.io/Vue-Quick-Start/07/src/ex07-13.js)

obj2는 obj1과 동일한 속성 값을 가지고 있는 객체이긴 하지만 서로 다른 객체. obj2는 새로운 객체를 만든 후 obj1의 속성 값들을 obj2의 속성의 값으로 할당했을 뿐. obj3은 obj1의 속성값을 모두 포함하면서 새로운 속성이 추가된 새로운 객체. arr2은 arr1의 배열 요소의 앞, 뒤에 새로운 항목을 추가한 새로운 객체를 리턴.

**이와 같이 기존 객체의 속성이나 배열의 요소들을 포함하여 새로운 객체, 배열을 생성하고자 할 때 사용.**
